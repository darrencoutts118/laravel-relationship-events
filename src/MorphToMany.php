...
class MorphToMany extends MorphToManyBase implements EventDispatcher
{
    ...
    {
        if ($this->parent->fireModelMorphToManyEvent('toggling', $this->getRelationName(), $ids) === false) {
            return false;
        }
    ...
    {
        if ($this->parent->fireModelMorphToManyEvent('syncing', $this->getRelationName(), $ids) === false) {
            return false;
        }
    ...
    {
        if ($this->parent->fireModelMorphToManyEvent('updatingExistingPivot', $this->getRelationName(), $id, $attributes) === false) {
            return false;
        }
    ...
    {
        if ($this->parent->fireModelMorphToManyEvent('attaching', $this->getRelationName(), $id, $attributes) === false) {
            return false;
        }
    ...
    public function detach($ids = null, $touch = true)
    {
        ...
        if ($this->parent->fireModelMorphToManyEvent('detaching', $this->getRelationName(), $ids) === false) {
            return false;
        }
